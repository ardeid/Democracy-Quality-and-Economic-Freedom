...
###################################################################################
#Arbetisblatt zur Fixed Effekts Regression von df_all_cases mit dem Minimalmodell.#
###################################################################################
...
LDI_min = v2x_libdem ~ EconFree_Index 

## Component Indices
#Liberal Component
LIB_min = v2x_liberal ~ EconFree_Index

#Egalitarian Component
EGAL_min = v2x_egal ~ EconFree_Index

#Participative Component
PART_min = v2x_partip ~ EconFree_Index

#Deliberative Component
DELIB_min = v2xdl_delib ~ EconFree_Index

#Institutional Component
POLY_min = v2x_polyarchy ~ EconFree_Index
...
#Liberal-Democracy Index
LDI_pooled <- lm(LDI_min, data = df_LD)

#Liberal Component
LIB_pooled <- lm(LIB_min, data = df_LD)

#Egalitarian Component
EGAL_pooled <- lm(EGAL_min, data = df_LD)

#Participative Component
PART_pooled <- lm(PART_min, data = df_LD)

#Deliberative Component
DELIB_pooled <- lm(DELIB_min, data = df_LD)

#Institutional Component
POLY_pooled <- lm(POLY_min, data = df_LD)
...
#Liberal-Democracy Index
LDI_fe_y <- lm(update(LDI_min, ~. + year), data = df_LD)

#Liberal Component
LIB_fe_y <- lm(update(LIB_min, ~. + year), data = df_LD)

#Egalitarian Component
EGAL_fe_y <- lm(update(EGAL_min, ~. + year), data = df_LD)

#Participative Component
PART_fe_y <- lm(update(PART_min, ~. + year), data = df_LD)

#Deliberative Component
DELIB_fe_y <- lm(update(DELIB_min, ~. + year), data = df_LD)

#Institutional Component
POLY_fe_y <- lm(update(POLY_min, ~. + year), data = df_LD)
...
#Liberal-Democracy Index
LDI_fe_c <- lm(update(LDI_min, ~. + country_name), data = df_LD)

#Liberal Component
LIB_fe_c <- lm(update(LIB_min, ~. + country_name), data = df_LD)

#Egalitarian Component
EGAL_fe_c <- lm(update(EGAL_min, ~. + country_name), data = df_LD)

#Participative Component
PART_fe_c <- lm(update(PART_min, ~. + country_name), data = df_LD)

#Deliberative Component
DELIB_fe_c <- lm(update(DELIB_min, ~. + country_name), data = df_LD)

#Institutional Component
POLY_fe_c <- lm(update(POLY_min, ~. + country_name), data = df_LD)
...
#Liberal-Democracy Index
LDI_fe_c_y <- lm(update(LDI_min, ~. + country_name + year), data = df_LD)

#Liberal Component
LIB_fe_c_y <- lm(update(LIB_min, ~. + country_name + year), data = df_LD)

#Egalitarian Component
EGAL_fe_c_y <- lm(update(EGAL_min, ~. + country_name + year), data = df_LD)

#Participative Component
PART_fe_c_y <- lm(update(PART_min, ~. + country_name + year), data = df_LD)

#Deliberative Component
DELIB_fe_c_y <- lm(update(DELIB_min, ~. + country_name + year), data = df_LD)

#Institutional Component
POLY_fe_c_y <- lm(update(POLY_min, ~. + country_name + year), data = df_LD)
